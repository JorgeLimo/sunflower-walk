...
export const TIER_SETTINGS: Record<ViewportTier, TierSettings> = {
  desktop: {
    ...
    shadowMapSize: 1024,
    dpr: [1, 1.75],
    sunflowersPerTile: { foreground: 140, mid: 520, background: 1800 },
  ...
  tablet: {
    ...
    shadowMapSize: 768,
    dpr: [1, 1.5],
    sunflowersPerTile: { foreground: 96, mid: 360, background: 1240 },
  ...
  mobile: {
    ...
    shadowMapSize: 512,
    dpr: [1, 1.4],
    sunflowersPerTile: { foreground: 44, mid: 145, background: 520 },
