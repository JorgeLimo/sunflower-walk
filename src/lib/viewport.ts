...
export const TIER_SETTINGS: Record<ViewportTier, TierSettings> = {
  desktop: {
    ...
    shadowMapSize: 1024,
    dpr: [1, 1.75],
    sunflowersPerTile: { foreground: 165, mid: 820, background: 2500 },
  ...
  tablet: {
    ...
    shadowMapSize: 768,
    dpr: [1, 1.5],
    sunflowersPerTile: { foreground: 115, mid: 570, background: 1730 },
  ...
  mobile: {
    ...
    shadowMapSize: 512,
    dpr: [1, 1.4],
    sunflowersPerTile: { foreground: 52, mid: 230, background: 720 },
